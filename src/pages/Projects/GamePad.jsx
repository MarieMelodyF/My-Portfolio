        ...
        <main>
          <div className="rawg">
            ...
            <div className="about-rawg">
              <div>
                <h1>Gamepad-Rawg</h1>
                <h1> Site de recensement de jeux videos</h1>
              ...
              <p>
                - Tous les jeux de la même série (possiblité de naviguer sur le
                jeu au click)
              </p>
              ...
              <p>
                - Possibilité de changé de naviguer sur le jeu favoris, au click
              </p>
